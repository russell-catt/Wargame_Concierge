...
SOURCES:
  ...
  - https://gamefound.com/en/projects/redmakers/the-warcode (retrieval 2026-08-23)
  - https://pre-launch.thewarcode.com/ (retrieval 2026-08-23)

PURPOSE:
  Official STL path only. No third-party piracy. Proxy guidance until campaign
  fulfillment.

UPDATE_TRIGGER:
  Gamefound campaign closes; Field Commander tier delivers files; resin/FDM guidance updated.
-->

# STL sources — official path only

**`confidence: draft`** — sourcing notes for personal printing. **Support RedMakers through official channels.**

---

## Official source (only)

| Channel | What it provides | Status (2026-08-23) |
|---------|------------------|---------------------|
| [Gamefound — The Warcode](https://gamefound.com/en/projects/redmakers/the-warcode) | **Field Commander** tier and above — **STL files** for miniatures / deployment | Campaign target **Sep 2026**; files post-fulfillment |
| Core Box / Full Deployment retail | Physical pre-supported miniatures + terrain | At retail after campaign |

**Path pointer:** `raw/pointers/warcode_stl_sources.md`

There is **no** authorised third-party STL mirror in this repo. Do **not** commit STL binaries to git.
...
## Resin vs FDM (campaign copy — confirm at launch)
...
## Post-delivery checklist (future)

- [ ] Download STL package from Gamefound pledge manager
