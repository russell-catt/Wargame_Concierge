...
Per-game-system teaching content:

| System | Path | Status | Rules currency |
|--------|------|--------|-----------------|
...
Neither 40K nor Kill Team has a singular "Balance Dataslate" file this pass — both are **Core/universal + faction or team package updates** (owner lock, [`docs/handoffs/dataslate_0826/track_in.md`](../docs/handoffs/dataslate_0826/track_in.md)). Teaching paraphrase — verify owned PDFs before tournament play.
