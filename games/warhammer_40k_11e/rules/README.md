...
OWNER: Russell Catt
AUTHOR_OF_NOTES: Cursor (Implementer, track dataslate_0826 / S5; S2e provenance)
...
**Rules currency:** this folder's piece of the **40K Aug 2026 package** is Universal Rules Updates v1.1 (above). Faction Pack v1.2 and MFM v1.3 belong to army teaching, not this shared spine — see [`../README.md`](../README.md) for the full package stamp and [`../armies/necrons/README.md`](../armies/necrons/README.md) / [`../armies/space_marines/README.md`](../armies/space_marines/README.md) for their pieces.
...
## Change Log
- v0.6.1 (2026-08-27): Added a "Rules currency" pointer line naming this folder's place in the 40K Aug 2026 package and linking to the system README / army READMEs for the other pieces (track `dataslate_0826` slice S5; no rewrite of S2e's v1.1 content).
