...
REFERENCE_STATUS: Active — companion to Army_List_500_Matched_Statted.md
...
**When:** Start of **your** Command phase — free.  
...
## Gladius Combat Doctrines (optional spice)

Each **once per battle**, whole army, your Command phase:

| Doctrine | Lets you… | Burn it when… |
|----------|-----------|---------------|
| **Devastator** | Shoot after you **Advanced** | You need guns *and* board inches early |
| **Tactical** | Shoot **and** charge after **Fall Back** | Your brick is stuck in a bad fight |
| **Assault** | Charge after you **Advanced** | The all-in turn |

Skipping a round is fine. **Adaptive Strategy (1CP)** puts **one unit** into any doctrine (even a used one).
...
Terminators have **Deep Strike**. That changes *where* they can arrive, not *when*.

### Three arrival tools (don’t mix the inches)

| Tool | When it happens | Where they set up | Notes |
|------|-----------------|-------------------|-------|
| **Strategic Reserves** | Your Movement phase, from **battle round 2** | Usually within **6″** of a battlefield **edge**, and **more than 8″** from enemies | Cap: reserves ≤ 50% of list points. Still off the board at end of round 3 → destroyed |
| **Deep Strike** (their ability) | Same timing window as reserves arrival | **Anywhere** more than **8″** from enemies (not edge-locked) | This is why Terminators feel scary |
| **Rapid Ingress** (Core stratagem, **1CP**) | **End of opponent’s Movement phase** | Same setup rules as if they arrived normally (Deep Strike → >8″ anywhere) | Not in battle round 1. They arrive *before* your turn — then you can shoot/charge on your turn |

**Distance triad (say it every game):** coherency **2″/9″** · Ingress edge **6″** · Deep Strike / reserves gap **>8″**. Different jobs — don’t call the 6″ “coherency.”

### Son’s default Terminator plan
...
## First three games — success looks like
