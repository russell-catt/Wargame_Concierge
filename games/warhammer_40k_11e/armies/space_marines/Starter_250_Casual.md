...
PURPOSE:
  250-point casual learning list using owned Legends mobility where it still makes a cogent force.
...
## Owned path BR-C — Captain + bikes: 215 / 250

Combined table (one list, not an add-on sheet).
...
**Lesson:** Oath + Advance on bikes; Attack Bike as the melta threat. Agree Legends with opponent before dice.

---

## Matched-legal alternate (no Legends)

If the opponent wants matched-only rules at 250, switch to [`Starter_250_Matched.md`](Starter_250_Matched.md) (BR-1 Terminators or BR-2 Captain + Tacticals).
...
- [ ] Confirm bikes against [`Owned_Models_Inventory.md`](Owned_Models_Inventory.md)
- [ ] Re-check Legends Field Manual points
