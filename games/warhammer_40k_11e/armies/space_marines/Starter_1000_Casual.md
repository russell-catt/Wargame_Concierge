...
PURPOSE:
  1000-point casual capstone: all owned Legends that fit into one cogent combined table.
...
## Owned path BR-C — double brick + all Legends: 995 / 1000
...
### Why this is the “all Legends” primary

| Owned Legends | In this list? |
|---------------|---------------|
| Astartes Servitors ×4 | Yes |
| Bike Squad ×3 | Yes |
| Attack Bike ×1 | Yes |

---

## Variant — keep Whirlwind, drop second Terminator: 995 / 1000

Artillery + one brick + all Legends:
...
| Adjustment | Total |
|------------|-------|
| Variant table above without Honour Vehement | **995** |

---

## Matched play instead

Tournament / matched: [`Starter_1000_Matched.md`](Starter_1000_Matched.md) — Techmarine alone, no Servitors/bikes costed, Whirlwind kept.

---

## Before you play

- [ ] Opponent agrees to **all three** Legends units (or trim openly)
- [ ] Confirm Techmarine + Servitors + bikes + both Terminator Squads
- [ ] Chaplain claw = Storm Shield note
- [ ] Re-check Legends FM + MFM
...
- Matched twin: [`Starter_1000_Matched.md`](Starter_1000_Matched.md)
- [`Starter_750_Casual.md`](Starter_750_Casual.md) · [`Starter_500_Casual.md`](Starter_500_Casual.md)
