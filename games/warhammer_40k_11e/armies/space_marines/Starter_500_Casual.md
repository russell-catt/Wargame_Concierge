<!--
FILE: games/warhammer_40k_11e/armies/space_marines/Starter_500_Casual.md
...
SOURCES:
  ...
  - Warhammer Legends Field Manual (WarCom PDF, retrieved 2026-08-22) — cross-checked, same figures now folded into MFM Marines v1.3 Legends section
...
PURPOSE:
  500-point casual list: Firstborn gun line + owned Legends mobility in one combined table.
...
Twenty-five spare. Terminators return on the Matched twin or at Casual 750+.

**How to play:** Captain on Tacticals for OC; Devastators hold a lane; bikes + Attack Bike hunt flanks / Oath targets.

---

## Want the Terminator brick instead?

Use [`Starter_500_Matched.md`](Starter_500_Matched.md) (no Legends) or step up to [`Starter_750_Casual.md`](Starter_750_Casual.md) where a brick and Legends both fit.

---

## Before you play

- [ ] Opponent agrees to **Legends**
- [ ] Inventory check for bikes + Tac/Dev
- [ ] Re-check Legends FM + MFM points
...
## Change Log
- v1.2 (2026-08-27): dataslate_0826 S2b — SM Codex October preview callout (Tac/Dev → future Legendary Proxies); preview footer line; no early points/stat swap.
