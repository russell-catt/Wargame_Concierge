...
| `40k_sm_how_army_works_500.html` | [`../How_Your_Army_Works_500.md`](../How_Your_Army_Works_500.md) | 4 |
...
python _html_to_pdf.py   # if present; else browser Print → PDF
```

Copy PDFs to `C:\Personal\print_aids\40k_11e\`.
