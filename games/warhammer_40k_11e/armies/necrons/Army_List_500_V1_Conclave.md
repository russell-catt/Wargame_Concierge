...
PURPOSE:
  ...
  kitchen-table Hierotek proxies.
...
|-----------|--------|---------|
| Necron Warriors (10) | Royal Warden (Despotek proxy) | Cryptek Geomancer |
| Immortals (5) | — | Technomancer **or** Plasmancer (Apprentek proxy) |

Put the spare Cryptek on the Immortals brick. Scarabs are independent.
...
| | |
|--|--|
| **Profile / weapons** | **VERIFY** — [Wahapedia Geomancer](https://wahapedia.ru/wh40k11ed/factions/necrons/Geomancer) / owned pack |
| **Role** | Support on Warriors; Conclave menu bearer; Warlord |
| **Detachment** | Cryptek guns `[ASSAULT]`; attached unit picks one Technosorcerous Augmentations ability when it shoots |
| **Enhancement** | Atomic Disintegrators — anti-Monster / anti-Vehicle options on that menu |

| Model | M | T | SV | W | LD | OC |
|-------|---|---|----|---|----|----|
| Geomancer | | | | | | |

### Technomancer (Canoptek Cloak) — 80 pts

| | |
|--|--|
| **Owned** | Hierotek photo ID 2026-08-17 |
| **Profile / weapons / cloak** | **VERIFY** — [Wahapedia Technomancer](https://wahapedia.ru/wh40k11ed/factions/necrons/Technomancer) / owned pack |
| **Attaches to** | Immortals, Warriors, or Canoptek Wraiths (MFM / datasheet) |
| **Detachment** | Same Conclave Cryptek package as Geomancer |
...
| | |
|--|--|
| **Legal note** | Kitchen-table only. Apprentek is not a Plasmancer kit. Prefer real Plasmancer for events |
| **Profile / weapons** | **VERIFY** — [Wahapedia Plasmancer](https://wahapedia.ru/wh40k11ed/factions/necrons/Plasmancer) |
| **Attaches to** | Immortals or Necron Warriors |
| **Detachment** | Cryptek Support — Conclave menu on attached unit |

### Royal Warden (Despotek proxy) — 50 pts

| | |
|--|--|
| **Legal note** | Kitchen-table Leader proxy. Despotek may instead count as an Immortal body |
| **Profile / weapons** | **VERIFY** — [Wahapedia Royal Warden](https://wahapedia.ru/wh40k11ed/factions/necrons/Royal-Warden) |
| **Why take it** | Leader + Cryptek Support on the same Warrior brick; Fall Back then still shoot/charge (confirm sheet); once-per-battle un-battleshock (confirm sheet) |
...
**Abilities:** Reanimation Protocols; Their Number is Legion (read datasheet). With Warden + Geomancer attached → Conclave Cryptek unit for the shooting menu.
...
**Owned loadout:** Hierotek Guardians carry gauss blasters - use blasters unless you build tesla on sprue models. **Abilities:** Reanimation Protocols. With Technomancer or Plasmancer proxy attached → Conclave Cryptek unit.

---

## Canoptek Scarab Swarms (6) — 80 pts
...
**Abilities:** Reanimation Protocols. **No Conclave gun buff** (not a Cryptek unit). Job: screen, sticky midfield, die cheaply.
...
- [ ] Character profile blanks filled from pack / Wahapedia
...
- [`Cryptek_Conclave.md`](Cryptek_Conclave.md) · [`Reanimation_Protocols.md`](Reanimation_Protocols.md)
...
- Teaching paraphrase for personal use. Proxies are not matched-play claims.

## Rising Tide Notes
- Verify profiles and proxy agreements before you play. Dated **2026-08-19**.
