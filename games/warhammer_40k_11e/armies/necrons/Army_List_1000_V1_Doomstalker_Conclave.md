...
SOURCES:
  ...
  - https://wahapedia.ru/wh40k11ed/factions/necrons/Canoptek-Doomstalker (2026-09-24)

PURPOSE:
  Kitchen-table / learning 1,000-pt Cryptek Conclave list that spends $0 on
  Szeras or Lychguard by using the owned Doomstalker + Hierotek Circle cast.

UPDATE_TRIGGER:
  Update when Doomstalker is painted, proxies replaced, or MFM points change.
-->

# Army list — 1,000 pts V1 — Cryptek Conclave (Doomstalker + Hierotek)

> **FORCE DISPOSITION — write on the list before you deploy**
> **Priority Assets** · MFM: `CRYPTEK CONCLAVE - 2DP - PRIORITY ASSETS`
> Matching Primaries: [`Cryptek_Conclave_Primary_Missions.md`](Cryptek_Conclave_Primary_Missions.md) · How matching works: [`../../setup/Chapter_Approved_Force_Dispositions.md`](../../setup/Chapter_Approved_Force_Dispositions.md) · Mission 38: [`../../setup/WD527_Monthly_Mission.md`](../../setup/WD527_Monthly_Mission.md) · Wound: [`../../rules/Wound_Roll_Reference.md`](../../rules/Wound_Roll_Reference.md)
...
## Attachments (declare before deploy)
...
## Canoptek Doomstalker — quick card

| Model | M | T | SV | W | LD | OC | Inv |
|-------|---|---|----|---|----|----|-----|
| Canoptek Doomstalker | 8" | 8 | 3+ | 12 | 8+ | 4 | 4+ |
...
**Abilities:** Reanimation Protocols; Deadly Demise D3; **Sentinel Construct** (Overwatch hits on 5+). **Damaged (1–4W):** −1 to Hit.

Detail: [`units/research/Canoptek-Doomstalker.md`](units/research/Canoptek-Doomstalker.md).

Other unit cards: [`Army_List_500_V1_Conclave.md`](Army_List_500_V1_Conclave.md), [`Army_List_750_V1_Conclave.md`](Army_List_750_V1_Conclave.md), Scarab research for Self-destruction.
...
- [`Starter_Forces_500_750_1000.md`](Starter_Forces_500_750_1000.md) — path index
- [`Army_List_1000_V2_Conclave.md`](Army_List_1000_V2_Conclave.md) — old buy path (Szeras + Lychguard)
- [`Cryptek_Conclave.md`](Cryptek_Conclave.md) · [`How_Your_Army_Works_500.md`](How_Your_Army_Works_500.md)
