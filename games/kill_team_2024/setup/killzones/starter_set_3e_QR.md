...
**Board:** Ready. Lowest friction learning table.

| Step | Do |
|------|-----|
| 1 | Starter boards/terrain as insert shows |
| 2 | Prefer Joint Ops Mission 1 for co-op |
| 3 | Or Preliminary Ops for PvP learning |
