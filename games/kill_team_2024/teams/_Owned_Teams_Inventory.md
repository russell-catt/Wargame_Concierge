...
OWNER: Russell Catt
AUTHOR_OF_NOTES: Cursor (Implementer, slice S3; slice S4 Canoptek Circle row update; slice S5 Plague Marines row update; slice S6 Angels of Death row update; cloud agent Intercessor photo ID 2026-08-21)
...
- v1.6 (2026-08-21): Angels of Death — partial photo ID (5 used Intercessors; BT paint not played as BT).
