...
Path-pointer stubs for owned local libraries and living web references. **Never embed GW binaries.**

| System | Library root | Pointer prefix |
|--------|--------------|----------------|
| Warhammer 40,000 11e | `C:\Personal\40K` | existing `rules_core.md`, faction packs, etc. |
