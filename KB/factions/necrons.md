...
## Why this is the learning army

Not because it is the easiest - because it is the one that is owned. Every teaching decision in this project follows from the collection described below.
...
Two paths are costed from this collection. Neither is committed to.
...
## Key terms this faction introduces

| Term | Meaning here |
|------|--------------|
| **Canoptek** | The robotic construct family - Scarabs, Wraiths, Doomstalkers. The [[canoptek_court]] theme |
