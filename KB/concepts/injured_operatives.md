...
- **Marker carrying survives incapacitation, briefly.** The free Place Marker action on incapacitation (0AP, overrides most "cannot" rules) means killing a marker-carrier does not automatically drop the marker wherever it likes for you - the dying player still chooses where to place it, within control range.
