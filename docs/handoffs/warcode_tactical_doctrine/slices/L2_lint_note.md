...
| `Warhammer` / `40,000` / `40K` / `40k` under `games/the_warcode/` | **PASS** — extended ban v0.5.5; content scrub 2026-08-24 (Rawmallet / 39.876 / 39.9) |
...
- Removed forbidden GW comparator proper nouns from shipping tree (14 replacements across 5 files; README policy line uses obfuscated forms only)
